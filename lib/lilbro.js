...
writers.devent_forwarder = require('./writers/devent_forwarder');
writers.devent_zmq = require('./writers/devent_zmq');
writers.file = require('./writers/file');
...
module.exports.initialize = function(options) {
	...
	writer = new writers[options.writer](options);
}
